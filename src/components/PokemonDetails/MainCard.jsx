    ...
    <div className=" bg-white  relative rounded shadow">
      ...
      <div className="m-5">
        ...
        <div class="w-full bg-gray-200 rounded-full h-5 mb-6">
          <div class="bg-green-400 h-5 rounded-full " style={StatsStyle.HP}>
        ...
        <div class="w-full bg-gray-200 rounded-full h-5 mb-6">
          <div class="bg-blue-400 h-5 rounded-full  " style={StatsStyle.Attack}>
            <span className="text-sm align-middle font-bold flex justify-end mr-2 ">
              {Stats.Attack}/150
            </span>
          </div>
        ...
        <div class="w-full bg-gray-200 rounded-full h-5 mb-6">
          <div
            class="bg-yellow-400 h-5 rounded-full  "
        ...
        <div class="w-full bg-gray-200 rounded-full h-5">
          <div class="bg-red-400 h-5 rounded-full " style={StatsStyle.Speed}>
            <span className="text-sm align-middle font-bold flex justify-end mr-2 ">
              {Stats.Speed}/150
            </span>
          </div>
